...
*/}}
{{- define "dataprepper-operator.name" -}}
...
*/}}
{{- define "dataprepper-operator.fullname" -}}
...
*/}}
{{- define "dataprepper-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "dataprepper-operator.resourceName" -}}
{{- $fullname := include "dataprepper-operator.fullname" .context }}
{{- $suffix := .suffix }}
